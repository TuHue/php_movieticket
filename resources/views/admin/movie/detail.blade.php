                ...
                <form class="user">
                    <div class="form-group row">
                        <div class="col-12">
                            ...
                            <div class="col-sm-11">
                                <H4 id="staticEmail">NGƯỜI ANH HÙNG TRÊN THẢO NGUYÊN</H4>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-sm-6">
                                <p id="staticTomtat">Miêu tả tóm tắt nội dung bộ phim</p>
                            </div>
                        </div>
                    </div>
