...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/css/admin/main.css') }}">
    <link
        ...
        <ul class="admin-menu">
            ...
            <li>
                <a href="/admin/dashboard">
                    ...
                    <span>Quản lý người đặt vé</span>
                </a>
            </li>
            <li>
                <a href="/admin/movie">
...
<section class="page-content">
    ...
    <footer class="page-footer">
        <span>Made by </span>
        <a href="https://www.facebook.com/profile.php?id=100015041566405" target="_blank">
