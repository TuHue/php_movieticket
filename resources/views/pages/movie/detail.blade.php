...
@section('content')
    <!-- ==========Banner-Section========== -->
    <section class="details-banner bg_img" data-background="{{ URL::asset('assets/images/banner/banner03.jpg') }}">
        <div class="container">
            <div class="details-banner-wrapper">
                <div class="details-banner-thumb">
                    <img src="{{ URL::asset('assets/images/movie/venus.jpg') }}" alt="movie">
                    <a href="https://www.youtube.com/embed/KGeBMAgc46E" class="video-popup">
                        <img src="{{ URL::asset('assets/images/movie/video-button.png') }}" alt="movie">
                    </a>
                </div>
                ...
                <div class="left-side">
                    <div class="item">
                        <div class="item-header">
                            <div class="thumb">
                                <img src="{{ URL::asset('assets/images/movie/tomato2.png') }}" alt="movie">
                            </div>
                    ...
                    <div class="item">
                        <div class="item-header">
                            <div class="thumb">
                                <img src="{{ URL::asset('assets/images/movie/cake2.png') }}" alt="movie">
                            </div>
                            <div class="counter-area">
                                <span class="counter-item odometer" data-odometer-final="88">0</span>
                            </div>
                ...
                <div class="col-lg-9 mb-50">
                    <div class="movie-details">
                        ...
                        <div class="details-photos owl-carousel">
                            <div class="thumb">
                                <a href="{{ URL::asset('assets/images/movie/movie-details01.jpg') }}"
                                    class="img-pop">
                                    <img src="{{ URL::asset('assets/images/movie/movie-details01.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="{{ URL::asset('assets/images/movie/movie-details02.jpg') }}"
                                    class="img-pop">
                                    <img src="{{ URL::asset('assets/images/movie/movie-details02.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="{{ URL::asset('assets/images/movie/movie-details03.jpg') }}"
                                    class="img-pop">
                                    <img src="{{ URL::asset('assets/images/movie/movie-details03.jpg') }}" alt="movie">
                                </a>
                            </div>
                            <div class="thumb">
                                <a href="{{ URL::asset('assets/images/movie/movie-details01.jpg') }}"
                                        ...
                                        <div class="casting-slider owl-carousel">
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ URL::asset('assets/images/cast/cast01.jpg') }}"
                                                            alt="cast">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ URL::asset('assets/images/cast/cast02.jpg') }}"
                                                            alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ URL::asset('assets/images/cast/cast03.jpg') }}"
                                                            alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ URL::asset('assets/images/cast/cast04.jpg') }}"
                                                            alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="casting-slider-two owl-carousel">
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ URL::asset('assets/images/cast/cast05.jpg') }}"
                                                            alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ URL::asset('assets/images/cast/cast06.jpg') }}"
                                                            alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ URL::asset('assets/images/cast/cast07.jpg') }}"
                                                            alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                            ...
                                            <div class="cast-item">
                                                <div class="cast-thumb">
                                                    <a href="#0">
                                                        <img src="{{ URL::asset('assets/images/cast/cast08.jpg') }}"
                                                            alt="cast">
                                                    </a>
                                                </div>
                                                <div class="cast-content">
                                ...
                                <div class="tab-item">
                                    ...
                                    <form action="comment" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input required type="email" class="form-control " name="email_cmt"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" name="binh_luan"
                                                    aria-describedby="emailHelp" placeholder="Nhập bình luận..."
                                                    id="binh_luan"></textarea>
